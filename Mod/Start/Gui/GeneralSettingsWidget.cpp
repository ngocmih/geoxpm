...
void GeneralSettingsWidget::setupUi()
{
    ...
    // createHorizontalUi();   //NataES
    createVerticalUi();        //NataES
    retranslateUi();
}

// void GeneralSettingsWidget::createHorizontalUi()   //NataES
void GeneralSettingsWidget::createVerticalUi()        //NataES
{

...
void FirstStartWidget::setupUi()
{
   ...
   // _welcomeLabel = gsl::owner<QLabel*>(new QLabel);       //NataES
   // outerLayout->addWidget(_welcomeLabel);                  //NataES
...
void FirstStartWidget::retranslateUi()
{
    ...
    QString application = QString::fromUtf8(App::Application::Config()["ExeName"].c_str());
    //_welcomeLabel->setText(QLatin1String("<h1>") + tr("Welcome to %1").arg(application)        //NataES
                        //   + QLatin1String("</h1>"));

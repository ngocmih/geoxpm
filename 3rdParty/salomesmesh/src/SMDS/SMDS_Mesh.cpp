...
//      MESSAGE("  " << myGrid->GetCell(i)->GetCellType());
  ...
  //vtkCellLinks *links = static_cast<vtkCellLinks*>(myGrid->GetCellLinks());	// NATAES Son - 12.2024
  vtkCellLinks *links = static_cast<vtkCellLinks*>(myGrid->GetLinks());			// NATAES Son - 12.2024
#else
  //vtkCellLinks *links = myGrid->GetCellLinks();	// NATAES Son - 12.2024
  vtkCellLinks *links = myGrid->GetLinks();			// NATAES Son - 12.2024
#endif
  for (int i=0; i<nbPoints; i++)
  {

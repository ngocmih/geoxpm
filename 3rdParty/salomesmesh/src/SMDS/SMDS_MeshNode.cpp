...
void SMDS_MeshNode::init(int id, int meshId, int shapeId, double x, double y, double z)
{
  ...
  //SMDS_CellLinks *cellLinks = dynamic_cast<SMDS_CellLinks*>(grid->GetCellLinks());	// NATAES Son - 12.2024
  SMDS_CellLinks *cellLinks = dynamic_cast<SMDS_CellLinks*>(grid->GetLinks());			// NATAES Son - 12.2024
  assert(cellLinks);
...
{
  //vtkCellLinks::Link l = static_cast<vtkCellLinks*>(SMDS_Mesh::_meshList[myMeshId]->getGrid()->GetCellLinks())->GetLink(myVtkID);	// NATAES Son - 12.2024
  vtkCellLinks::Link l = static_cast<vtkCellLinks*>(SMDS_Mesh::_meshList[myMeshId]->getGrid()->GetLinks())->GetLink(myVtkID);		// NATAES Son - 12.2024
...
void SMDS_MeshNode::AddInverseElement(const SMDS_MeshElement* ME)
{
  ...
  //vtkCellLinks *Links = static_cast<vtkCellLinks*>(grid->GetCellLinks());	// NATAES Son - 12.2024
  vtkCellLinks *Links = static_cast<vtkCellLinks*>(grid->GetLinks());		// NATAES Son - 12.2024

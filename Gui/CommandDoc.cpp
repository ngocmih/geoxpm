...
#include "pqparaviewInitializer.h"            // NATAES Son - 12.2024
extern pqparaviewInitializer* pvInitializer;  // NATAES Son - 12.2024
#include <QString>                            //hieu S
#include <QPushButton>
#include <QFormLayout>
#include <QGroupBox>
#include <QTextEdit>
...
QString createDefaultExportBasename()
{
    ...
    // %F - the basename of the.FCStd file(or the label, if it is not saved yet)
    QString docFilename =
        QString::fromUtf8(App::GetApplication().getActiveDocument()->getFileName());
    QFileInfo fi(docFilename);
    QString fcstdBasename = fi.completeBaseName();
    if (fcstdBasename.isEmpty()) {
        fcstdBasename =
            QString::fromStdString(App::GetApplication().getActiveDocument()->Label.getStrValue());
    }
...
void StdCmdExport::activated(int iMsg)
{
    ...
    if (selection.empty()) {
        QMessageBox::warning(
            ...
            QCoreApplication::translate("StdCmdExport",
                                        "Select the objects to export before choosing Export."));
        return;
    }
    ...
    if (defaultFilename.isEmpty() || lastExportUsedGeneratedFilename || didActiveDocumentChange) {
        ...
        if (lastExportUsedGeneratedFilename
            || didActiveDocumentChange) { /*<- static, true on first call*/
...
//===========================================================================
// Std_New_ FreeCAD_sua sang cua GeoXPM
//===========================================================================
...
//     ParameterGrp::handle hViewGrp = App::GetApplication().GetParameterGroupByPath("User
//     parameter:BaseApp/Preferences/View"); if (hViewGrp->GetBool("ShowAxisCross"))
...
// NATAES Ngoc - 2.2025 - start
//===========================================================================
// Std_SwitchToGeometry
//===========================================================================
DEF_STD_CMD_A(StdCmdSwitchToGeometry)
StdCmdSwitchToGeometry::StdCmdSwitchToGeometry()
    : Command("Std_SwitchToGeometry")
{
    sGroup = "Stages";
    sMenuText = QT_TR_NOOP("Geometry");
    sToolTipText = QT_TR_NOOP("");
    // sPixmap = "";
}
void StdCmdSwitchToGeometry::activated(int)
{}
bool StdCmdSwitchToGeometry::isActive()
{
    return true;
}

//===========================================================================
// Std_SwitchToStructures
//===========================================================================
DEF_STD_CMD_A(StdCmdSwitchToStructures)
StdCmdSwitchToStructures::StdCmdSwitchToStructures()
    : Command("Std_SwitchToStructures")
{
    sGroup = "Stages";
    sMenuText = QT_TR_NOOP("Structures");
    sToolTipText = QT_TR_NOOP("..");
    // sPixmap = "..";
}
void StdCmdSwitchToStructures::activated(int)
{}
bool StdCmdSwitchToStructures::isActive()
{
    return true;
}

//===========================================================================
// Std_SwitchToMaterials
//===========================================================================
DEF_STD_CMD_A(StdCmdSwitchToMaterials)
StdCmdSwitchToMaterials::StdCmdSwitchToMaterials()
    : Command("Std_SwitchToMaterials")
{
    sGroup = "Stages";
    sMenuText = QT_TR_NOOP("Materials");
    sToolTipText = QT_TR_NOOP("..");
    // sPixmap = "..";
}
void StdCmdSwitchToMaterials::activated(int)
{}
bool StdCmdSwitchToMaterials::isActive()
{
    return true;
}

//===========================================================================
// Std_SwitchToHydraulics
//===========================================================================
DEF_STD_CMD_A(StdCmdSwitchToHydraulics)
StdCmdSwitchToHydraulics::StdCmdSwitchToHydraulics()
    : Command("Std_SwitchToHydraulics")
{
    sGroup = "Stages";
    sMenuText = QT_TR_NOOP("Hydraulics");
    sToolTipText = QT_TR_NOOP("..");
    // sPixmap = "..";
}
void StdCmdSwitchToHydraulics::activated(int)
{}
bool StdCmdSwitchToHydraulics::isActive()
{
    return true;
}
...
// Std_SwitchToMeshing
//===========================================================================
DEF_STD_CMD_A(StdCmdSwitchToMeshing)
StdCmdSwitchToMeshing::StdCmdSwitchToMeshing()
    : Command("Std_SwitchToMeshing")
{
    sGroup = "Stages";
    sMenuText = QT_TR_NOOP("Meshing");
    sToolTipText = QT_TR_NOOP("..");
    // sPixmap = "..";
}
void StdCmdSwitchToMeshing::activated(int)
{}
bool StdCmdSwitchToMeshing::isActive()
{
    return true;
}

//===========================================================================
// Std_SwitchToStagedConstruction
//===========================================================================
DEF_STD_CMD_A(StdCmdSwitchToStagedConstruction)
StdCmdSwitchToStagedConstruction::StdCmdSwitchToStagedConstruction()
    : Command("Std_SwitchToStagedConstruction")
{
    sGroup = "Stages";
    sMenuText = QT_TR_NOOP("Staged Construction");
    sToolTipText = QT_TR_NOOP("..");
    // sPixmap = "..";
}
void StdCmdSwitchToStagedConstruction::activated(int)
{}
bool StdCmdSwitchToStagedConstruction::isActive()
{
    return true;
}
...
// Std_FillBox
//===========================================================================
DEF_STD_CMD_A(StdCmdFillBox)
StdCmdFillBox::StdCmdFillBox()
    : Command("Std_FillBox")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("FillBox");
    sToolTipText = QT_TR_NOOP("..");
    sWhatsThis = "..";
    sStatusTip = QT_TR_NOOP("..");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
}

void StdCmdFillBox::activated(int iMsg)
{}

bool StdCmdFillBox::isActive()
{
    return true;
}
...
DEF_STD_CMD_A(StdCmdOpenParaView)

StdCmdOpenParaView::StdCmdOpenParaView()
    : Command("Std_OpenParaView")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Open ParaView");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdOpenParaView::activated(int iMsg)
{
    Q_UNUSED(iMsg);
    pvInitializer->show();  // NATAES Son - 12.2024
}

bool StdCmdOpenParaView::isActive()
{
    return true;
}
...
DEF_STD_CMD_A(StdCmdImport3Dobject)

StdCmdImport3Dobject::StdCmdImport3Dobject()
    : Command("Std_Import3Dobject")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Import 3D object");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdImport3Dobject::activated(int iMsg)
{}

bool StdCmdImport3Dobject::isActive()
{
    return true;
}

//===========================================================================
// Std_Materialproperties
//===========================================================================

DEF_STD_CMD_A(StdCmdMaterialproperties)

StdCmdMaterialproperties::StdCmdMaterialproperties()
    : Command("Std_Materialproperties")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Material Properties");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdMaterialproperties::activated(int iMsg)
{}

bool StdCmdMaterialproperties::isActive()
{
    return true;
}
...
DEF_STD_CMD_A(StdCmdSoilTests)

StdCmdSoilTests::StdCmdSoilTests()
    : Command("Std_SoilTests")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Soil tests");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdSoilTests::activated(int iMsg)
{}

bool StdCmdSoilTests::isActive()
{
    return true;
}

//===========================================================================
// Std_SoilStructureInteraction
//===========================================================================

DEF_STD_CMD_A(StdCmdSoilStructureInteraction)

StdCmdSoilStructureInteraction::StdCmdSoilStructureInteraction()
    : Command("Std_SoilStructureInteraction")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Soil Structure Interaction");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdSoilStructureInteraction::activated(int iMsg)
{}

bool StdCmdSoilStructureInteraction::isActive()
{
    return true;
}

//===========================================================================
// Std_SoilWaterCouplingParametersInput
//===========================================================================

DEF_STD_CMD_A(StdCmdSoilWaterCouplingParametersInput)

StdCmdSoilWaterCouplingParametersInput::StdCmdSoilWaterCouplingParametersInput()
    : Command("Std_SoilWaterCouplingParametersInput")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Soil Water Coupling Parameters Input");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdSoilWaterCouplingParametersInput::activated(int iMsg)
{}

bool StdCmdSoilWaterCouplingParametersInput::isActive()
{
    return true;
}

//===========================================================================
// Std_AutofitSimulationDomain
//===========================================================================

DEF_STD_CMD_A(StdCmdAutofitSimulationDomain)

StdCmdAutofitSimulationDomain::StdCmdAutofitSimulationDomain()
    : Command("Std_AutofitSimulationDomain")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Autofit Simulation Domain");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdAutofitSimulationDomain::activated(int iMsg)
{}

bool StdCmdAutofitSimulationDomain::isActive()
{
    return true;
}
...
DEF_STD_CMD_A(StdCmdMeshingOrder)

StdCmdMeshingOrder::StdCmdMeshingOrder()
    : Command("Std_MeshingOrder")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("MeshingOrder");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdMeshingOrder::activated(int iMsg)
{}

bool StdCmdMeshingOrder::isActive()
{
    return true;
}

//===========================================================================
// Std_GenerateParticles
//===========================================================================

DEF_STD_CMD_A(StdCmdGenerateParticles)

StdCmdGenerateParticles::StdCmdGenerateParticles()
    : Command("Std_GenerateParticles")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("GenerateParticles");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdGenerateParticles::activated(int iMsg)
{}

bool StdCmdGenerateParticles::isActive()
{
    return true;
}
...
DEF_STD_CMD_A(StdCmdRemeshSSI)

StdCmdRemeshSSI::StdCmdRemeshSSI()
    : Command("Std_RemeshSSI")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Remesh SSI");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdRemeshSSI::activated(int iMsg)
{}

bool StdCmdRemeshSSI::isActive()
{
    return true;
}

//===========================================================================
// Std_Execute simulations
//===========================================================================

DEF_STD_CMD_A(StdCmdExecuteSimulations)

StdCmdExecuteSimulations::StdCmdExecuteSimulations()
    : Command("Std_ExecuteSimulations")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Execute Simulations");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdExecuteSimulations::activated(int iMsg)
{}

bool StdCmdExecuteSimulations::isActive()
{
    return true;
}

//===========================================================================
// Std_Export output to Paraview
//===========================================================================

DEF_STD_CMD_A(StdCmdExportOutputToParaview)

StdCmdExportOutputToParaview::StdCmdExportOutputToParaview()
    : Command("Std_ExportOutputToParaview")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Export Output To Paraview");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdExportOutputToParaview::activated(int iMsg)
{}

bool StdCmdExportOutputToParaview::isActive()
{
    return true;
}

//===========================================================================
// Std_Export output to Tab format
//===========================================================================

DEF_STD_CMD_A(StdCmdExportOutputToTabFormat)

StdCmdExportOutputToTabFormat::StdCmdExportOutputToTabFormat()
    : Command("Std_ExportOutputToTabFormat")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Export Output To Tab Format");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdExportOutputToTabFormat::activated(int iMsg)
{}

bool StdCmdExportOutputToTabFormat::isActive()
{
    return true;
}

//===========================================================================
// Std_Execution parameters
//===========================================================================

DEF_STD_CMD_A(StdCmdExecutionParameters)

StdCmdExecutionParameters::StdCmdExecutionParameters()
    : Command("Std_ExecutionParameters")
{
    sGroup = "File";
    sMenuText = QT_TR_NOOP("Execution Parameters");
    sToolTipText = QT_TR_NOOP("");
    sWhatsThis = "";
    sStatusTip = QT_TR_NOOP("");
    sPixmap = "/home/nata1/Pictures/Vietnam.svg.png";
...
void StdCmdExecutionParameters::activated(int iMsg)
{
    // Tạo hộp thoại mới
    QDialog dialog;
    dialog.setWindowTitle(QObject::tr("Project Properties"));
...
bool StdCmdExecutionParameters::isActive()
{
    return true;
}
// NATAES Ngoc - 2.2025 - end
//===========================================================================
//  Std_SaveAll
//===========================================================================
...
void StdCmdRevert::activated(int iMsg)
{
    ...
    msgBox.setText(
        qApp->translate("Std_Revert", "This will discard all the changes since last file save."));
...
{
    Q_UNUSED(iMsg);
    Gui::Dialog::DlgProjectInformationImp dlg(getActiveGuiDocument()->getDocument(),
                                              getMainWindow());
    dlg.exec();
}
...
void StdCmdSelectAll::activated(int iMsg)
{
    ...
    std::vector<App::DocumentObject*> objs =
        doc->getObjectsOfType(App::DocumentObject::getClassTypeId());
    ...
    : Command("Std_Properties")
{
    ...
    sToolTipText =
        QT_TR_NOOP("Show the property view, which displays the properties of the selected object.");
...
void CreateDocCommands()
{
    ...
    // GeoXPM _ NATAES Ngoc - 2.2025 -start
    rcCmdMgr.addCommand(new StdCmdOpenParaView());
    rcCmdMgr.addCommand(new StdCmdFillBox());
    rcCmdMgr.addCommand(new StdCmdImport3Dobject());
    rcCmdMgr.addCommand(new StdCmdMaterialproperties());
    rcCmdMgr.addCommand(new StdCmdSoilTests());
    rcCmdMgr.addCommand(new StdCmdSoilStructureInteraction());
    rcCmdMgr.addCommand(new StdCmdSoilWaterCouplingParametersInput());
    rcCmdMgr.addCommand(new StdCmdAutofitSimulationDomain());
    rcCmdMgr.addCommand(new StdCmdMeshingOrder());
    rcCmdMgr.addCommand(new StdCmdRemeshSSI());
    rcCmdMgr.addCommand(new StdCmdExecuteSimulations());
    rcCmdMgr.addCommand(new StdCmdExportOutputToParaview());
    rcCmdMgr.addCommand(new StdCmdExportOutputToTabFormat());
    rcCmdMgr.addCommand(new StdCmdExecutionParameters());
    rcCmdMgr.addCommand(new StdCmdGenerateParticles());
    rcCmdMgr.addCommand(new StdCmdSwitchToGeometry());
    rcCmdMgr.addCommand(new StdCmdSwitchToStructures());
    rcCmdMgr.addCommand(new StdCmdSwitchToMaterials());
    rcCmdMgr.addCommand(new StdCmdSwitchToHydraulics());
    rcCmdMgr.addCommand(new StdCmdSwitchToMeshing());
    rcCmdMgr.addCommand(new StdCmdSwitchToStagedConstruction());
    // NATAES Ngoc - 2.2025 - end
}

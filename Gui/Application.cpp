...
void setAppNameAndIcon()
{
    ...
    // }
    QApplication::setApplicationName(QString::fromUtf8("NataES"));

// #ifndef Q_OS_MACOS
     QApplication::setWindowIcon(
//         Gui::BitmapFactory().pixmap(App::Application::Config()["AppIcon"].c_str()));
// #endif
    Gui::BitmapFactory().pixmap("/home/nata1/Pictures/Vietnam.svg.png"));
}
//NataES -12.2024 -end
...
pqparaviewInitializer* pvInitializer = new pqparaviewInitializer;	// NATAES Son - 12.2024

void Application::runApplication()
{
    StartupProcess::setupApplication();

    // NATAES Son - 12.2024 => start
	int argc_p = App::Application::GetARGC();											
	char** argv_p = App::Application::GetARGV();
	GeoXPM_paraview_setup(argc_p, argv_p);
	// NATAES Son - 12.2024 => end
...
// NATAES Son - 12.2024 => start
	pqparaviewInitializer::Status status = pvInitializer->Initialize(argc_p, argv_p);
	switch (status)
	{
